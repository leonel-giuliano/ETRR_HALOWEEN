...
void inicializar_monstruos(monster_t [], int);
void inicializar_monstruo(monster_t *);
void mostrar_monstruos(monster_t[], int);
void mostrar_monstruo(monster_t);
int elegir_monstruo(monster_t [CANT_MONSTERS]);
...
int main()
{
    ...
    while (juego_no_terminado)
    {
        ...
        while(index_contrincante == monstruo_elegido) {
            index_contrincante = numero_al_azar(0, CANT_MONSTERS);
        }
...
{
    int ataque1, defensa1, puntaje1, puntaje2;
    int ataque2 = numero_al_azar(0, CANT_DANIOS);
    int defensa2 = numero_al_azar(0, CANT_PODERES);
    int ganador;
    ...
    // for (int i = 0; i < CANT_DANIOS; i++)
    // {
    //     printf("Escribe %d para %s - ", (i + 1), monsters[monster2].danios[i].nombre);
    // }
    // printf("\n");
    // scanf("%d", &ataque2);
    ...
    // for (int i = 0; i < CANT_PODERES; i++)
    // {
    //     printf("Escribe %d para %s - ", (i + 1), monsters[monster2].poderes[i].nombre);
    // }
    // printf("\n");
    // scanf("%d", &defensa2);
    // printf("hola");
